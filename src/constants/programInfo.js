import logo from "../images/logo_techacademy.png" // add school logo to images folder and import here
...
export const schoolName = "The Tech Academy"

export const schoolURL = 'https://www.learncodinganywhere.com/' // update with url of school's website

export const skfURL = 'https://techacademy.skills.fund/' // update with Skills Fund url

export const headline = "Learn to Code at The Tech Academy" // update headline as appropriate

export const leadContent = {
    header: "Your last step on the path toward changing your career",
    paragraph: `${schoolName} designs its program to provide its students with a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const threeStepCardText = {
    ...
    step2: {
        ...
        text: "The Tech Academy focuses exclusively on its Software Developer Bootcamp."
    },
    step3: `You'll be on your way to an exciting career in tech as part of ${schoolName}'s powerful network.`
}

export const netlifyFormName = 'techacademy_contact'

export const GATracking = 'UA-68312423-1'

export const hubspotFormId = "2e630f2f-7d41-4ac7-8e2d-4ce619dec6eb" // create Hubspot form, get form id after publishing
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        ...
        url: "https://my.skills.fund/application?lenderCode=SKTA",
