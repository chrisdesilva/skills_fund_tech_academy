...
export const leadContent = {
  ...
  paragraph: `${schoolName} designs its program to provide its students with a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${
...
export const threeStepCardText = {
  ...
  step2: {
    ...
    text:
      "The Tech Academy focuses exclusively on its Software Developer Bootcamp.",
  },
...
export const programMaxText =
  "Choose the loan amount that works best for you. Borrow up to $19,980 for tuition at The Tech Academy."
